...
def linear_combination(distribution, languages, pos_accuracy=None):
...
def main(args):
    ...
    for combination in all_combinations:
        ...
        combined_result_lin = linear_combination(distribution,combination, separate_language_pos_accuracy)
